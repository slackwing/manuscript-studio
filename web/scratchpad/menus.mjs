...
import { schema } from './schema.mjs?v=2';
import { variationApi } from './api.mjs?v=2';
import { esc, letterOf, parseVariationRef, refreshSketchSiblings } from './sketch-view.mjs?v=4';

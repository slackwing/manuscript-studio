...
func TestCountProseWords(t *testing.T) {
	cases := []struct {
		...
		{"inline unknown command removed (bare #tag)", "It was &mark#interesting a strange night.", 5},
		{"inline unknown command removed (brace form)", "It was &mark{interesting} a strange night.", 5},
		{"unknown command alone → 0", "&mark#digression", 0},
